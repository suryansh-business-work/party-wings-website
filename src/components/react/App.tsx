  ...
  return (
    <QuoteProvider>
      ...
      <section className="text-center py-12">
        ...
        <p className="mt-3 max-w-2xl mx-auto text-slate-700 dark:text-slate-300">Full-service party and event management: decoration, catering, planning, photography and more. Select your city and add services to a package — then submit a request.</p>
      </section>
